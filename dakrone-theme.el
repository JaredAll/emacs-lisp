...
(custom-theme-set-faces
 ...
 '(font-lock-comment-face ((t (:foreground "#58D680"))))
 '(font-lock-string-face ((t (:foreground "#8AE234"))))
 ;;'(font-lock-keyword-face ((t (:foreground "#00ffff"))))
 '(font-lock-keyword-face ((t (:foreground "#FFC300"))))
 ...
 '(font-lock-type-face ((t (:foreground "#C223EC"))))
 ...
 '(clojure-keyword ((t (:foreground "#FFC300"))))
